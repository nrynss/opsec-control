...
// POST /events /perception /scenario/{load,reset,pause,resume,step,speed}. It serializes
// contract DTOs and forwards events to the bus. It is the ONLY package the frontend talks to.
//
