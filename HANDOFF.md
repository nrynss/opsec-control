...
| **P21** | 🔵 **Claimed** — DeepSeek V4 Pro (2026-06-29) | `internal/llm` | atomic counters for tokensIn, tokensOut, requestCount; expose TotalTokens(), TotalRequests(), ResetStats() (mock and real). | P19 |
